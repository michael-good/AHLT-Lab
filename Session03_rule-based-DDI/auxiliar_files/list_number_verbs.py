...
def main():
    ...
    feat_file_mechanism=open('verbs_mechanism.txt', 'r')
    ...
    feat_file_int=open('verbs_int.txt', 'r')
    ...
    feat_file_advise=open('verbs_advise.txt', 'r')
    ...
    feat_file_null=open('verbs_null.txt', 'r')

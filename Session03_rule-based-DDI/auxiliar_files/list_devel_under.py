...
def main():
    ...
    feat_file_effects=open('under_effects_devel.txt', 'r')
    ...
    feat_file_mechanism=open('under_mechanism_devel.txt', 'r')
    ...
    feat_file_int=open('under_int_devel.txt', 'r')
    ...
    feat_file_advise=open('under_advise_devel.txt', 'r')
    ...
    feat_file_null=open('under_null_devel.txt', 'r')

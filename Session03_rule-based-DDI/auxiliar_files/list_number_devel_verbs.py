...
def main():
    ...
    feat_file_effects=open('verbs_effect_devel.txt', 'r')
    dict_eff = {}
    #elements in general
    ...
    feat_file_mechanism=open('verbs_mechanism_devel.txt', 'r')
    dict_mecha = {}
    #elements in general
    ...
    feat_file_int=open('verbs_int_devel.txt', 'r')
    dict_int = {}
    #elements in general
    ...
    feat_file_advise=open('verbs_advise_devel.txt', 'r')
    dict_adv = {}
    #elements in general
    ...
    feat_file_null=open('verbs_null_devel.txt', 'r')
    dict_null = {}
    #elements in general
